...
def drawParallax(x_mouse, y_mouse):
    ...
    # tree
    treeX = (x_mouse - 400) * 0.05
    treeY = (y_mouse - 400) * 0.05
    # sun
    ...
    drawTrunk(treeX + 617, treeY + 320, 20, 150)  # draw the tree stump on the screen

    glColor3f(0.0, 0.5, 0.0)  # set color to darkgreen
    drawLeaves(treeX + 625, treeY + 450, 50, 50)  # draw the tree leaves on the screen
